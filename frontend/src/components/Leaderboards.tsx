...
const Leaderboards: React.FC<LeaderboardsProps> = ({ mapID }) => {
  ...
  React.useEffect(() => {
    ...
    console.log(data);
  }, [pageNumber, navigate, _fetch_map_leaderboards, data]);
            ...
            >
              ...
              {r.kind === "multiplayer" ? (
                <span>
                  ...
                  <button
                    onClick={() =>
                      (window.location.href = `/api/v1/demos?uuid=${r.partner_demo_id}`)
                    }
                  >
                    <img
                      src={DownloadIcon}
                  ...
                  <button
                    onClick={() =>
                      (window.location.href = `/api/v1/demos?uuid=${r.host_demo_id}`)
                    }
                  >
                    <img
                      src={DownloadIcon}
