...
const withGame = (gameID: number, maps: Record<string, number>): Record<string, MapRegistryEntry> =>
  Object.fromEntries(Object.entries(maps).map(([engineMapName, id]) => [
    engineMapName,
    { id, game_id: gameID },
  ]));

export const MapNames: Record<string, MapRegistryEntry> = {
  ...withGame(1, {
  "sp_a1_intro1": 1,
  "sp_a1_intro2": 2,
  "sp_a1_intro3": 3,
