...
export const get_map_leaderboard = async (
  map_id: string,
  page: string
): Promise<MapLeaderboard | undefined> => {
  const response = await axios.get(
    url(`maps/${map_id}/leaderboards?page=${page}`)
  );
...
export const get_map_discussions = async (
  map_id: string
): Promise<MapDiscussions | undefined> => {
...
export const get_map_discussion = async (
  map_id: string,
  discussion_id: number
): Promise<MapDiscussion | undefined> => {
  const response = await axios.get(
    url(`maps/${map_id}/discussions/${discussion_id}`)
  );
...
export const post_map_discussion = async (
  token: string,
  map_id: string,
  content: MapDiscussionContent
): Promise<boolean> => {
  const response = await axios.post(
    url(`maps/${map_id}/discussions`),
    {
      title: content.title,
...
export const post_map_discussion_comment = async (
  token: string,
  map_id: string,
  discussion_id: number,
  comment: string
...
export const delete_map_discussion = async (
  token: string,
  map_id: string,
  discussion_id: number
): Promise<boolean> => {
...
export const delete_map_record = async (
  token: string,
  map_id: number,
  record_id: number
): Promise<boolean> => {
  const response = await axios.delete(
    url(`maps/${map_id}/record/${record_id}`),
    {
      headers: {
        Authorization: token,
      },
