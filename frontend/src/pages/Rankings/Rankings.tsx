...
import RankingEntry from "@components/RankingEntry.tsx";
import {
  Ranking,
  SteamRanking,
  RankingType,
  SteamRankingType,
} from "@customTypes/Ranking.ts";
          ...
          <div className="ranks-container">
            ...
            {leaderboardLoad &&
              currentLeaderboard?.map((curRankingData, i) => {
                return (
                  <RankingEntry
                    currentLeaderboardType={currentLeaderboardType}
                    curRankingData={curRankingData}
                    key={i}
                  ></RankingEntry>
                );
              })}
